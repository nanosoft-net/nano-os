...
*/
    ...
    AREA |.nano_os_port_asm|, CODE, READONLY, ALIGN=2
    THUMB
    REQUIRE8
    PRESERVE8

/** \brief Service call number for the first context switch */
SVC_FIRST_CONTEXT_SWITCH        EQU     0x24
/** \brief Service call number to switch to priviledged mode */
SVC_SWITCH_TO_PRIVILEDGED_MODE  EQU     0xAA

/** \brief MPU control register */
MPU_CTRL_REG  EQU     0xE000ED94
/** \brief MPU region base address register */
MPU_RBAR_REG  EQU     0xE000ED9C

	EXPORT NANO_OS_PORT_GetTaskStackPointer

	EXPORT NANO_OS_PORT_SaveInterruptStatus
	EXPORT NANO_OS_PORT_RestoreInterruptStatus

	EXPORT NANO_OS_PORT_FirstContextSwitchAsm
	EXPORT NANO_OS_PORT_ContextSwitch
	EXPORT NANO_OS_PORT_ContextSwitchFromIsr

	EXPORT NANO_OS_PORT_SwitchToPriviledgedMode
	EXPORT NANO_OS_PORT_SwitchToUnpriviledgedMode

	EXPORT NANO_OS_PORT_SvcHandler
	EXPORT NANO_OS_PORT_PendSvHandler
